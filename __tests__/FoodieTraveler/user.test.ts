import { POST as createUser, GET as getUsers } from "@/app/api/FoodieTraveler/users/route";
import { GET as getUserById, PUT as updateUser } from "@/app/api/FoodieTraveler/users/[id]/route";
