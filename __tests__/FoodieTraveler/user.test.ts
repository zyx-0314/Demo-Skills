import { POST as createUser, GET as getUsers } from "@/app/api/old/FoodieTraveler/users/route";
import { GET as getUserById, PUT as updateUser } from "@/app/api/old/FoodieTraveler/users/[id]/route";
...
describe("User Management API Tests", () => {
  ...
  beforeAll(async () => {
    await prisma.userFoodie.deleteMany({ where: { email: testEmail } });
  });
