...
import { POST as createReview, GET as getReviews } from "@/app/api/old/FoodieTraveler/reviews/route";
import { PUT as updateReview, DELETE as deleteReview } from "@/app/api/old/FoodieTraveler/reviews/[id]/route";
